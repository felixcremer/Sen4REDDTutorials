...
begin
using ESDL
"The ESDL package implements the Earth system data lab datacube"
end
...
begin
using Dates
	"Dates is the standard library to deal with temporal information"
end

# ╔═╡ ed5fe8c0-5b0c-11eb-3a56-3586e748a59d
begin
using Glob
	"Glob is a package to implement file search after certain patterns"
end
...
md" In this tutorial we are exploring, how we can use the ESDL Julia datacube package to load and process raster datasets, which we can open with GDAL.
